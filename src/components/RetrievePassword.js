        ...
        <div className="border-2 w-[80rem] min-h-screen shadow-2xl max-h-full flex">
            ...
            <div className="border-2 w-full text-center flex flex-col justify-center items-center -ml-24">
                ...
                <form className="flex flex-col justify-center items-center">
                    <input placeholder="Enter your email" className="text-base border py-2 pl-4 pr-96 mb-8 text-left rounded-md" />
                    <Link to="/"><button className="text-base border rounded-md bg-blue text-white w-[37.5rem]  py-3">Retrieve</button></Link>
                </form>
            </div>
        </div>
    )
